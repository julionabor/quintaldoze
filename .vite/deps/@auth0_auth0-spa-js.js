...
var n = { name: "auth0-spa-js", version: "2.17.0" };
var o = () => Date.now();
...
var ra = class {
  ...
  _isInteractiveError(e3) {
    return e3 instanceof d || e3 instanceof r && this._isIframeMfaError(e3);
  }
  ...
  async _getTokenFromIFrame(e3) {
    ...
    try {
      ...
      if ("login_required" === e4.error) {
        e4 instanceof r && this._isIframeMfaError(e4) && "popup" === this.options.interactiveErrorHandler || this.logout({ openUrl: false });
      }
      throw e4;
    }
  }
